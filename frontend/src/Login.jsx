...
export default function Login({ onLoginSuccess }) {
  ...
  return (
    <div className="min-h-screen bg-[#070b19] flex flex-col items-center justify-center p-4 selection:bg-cyan-500 selection:text-white">
      ...
      {/* 🔗 BLOCO REGISTRAR-SE */}
      <div className="w-full max-w-md bg-[#111827]/40 border border-gray-800/80 rounded-xl py-4 px-8 mt-4 text-center text-xs">
        <span className="text-gray-400">Não tem uma conta? </span>
        <a href="#" className="font-bold text-[#00aedc] hover:underline">
          Registrar-se
        </a>
      </div>

      {/* 📅 RODAPÉ COPYRIGHT */}
      <p className="text-[10px] text-gray-600 tracking-wide mt-8">
